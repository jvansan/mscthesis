...
to draw an important conclusion: The use of \ch{Cl^-} in the calculations should
...
increasing the \ch{C-H} bond strength, and therefore HAT reaction barrier
height.
...
active metal complexation upon \ch{C-H} bond strengths as measured by BDEs.
Specifically, it neglects the effects of orbital interactions of the product
radical and metal cation, which can be either stabilizing or de-stabilizing,
which properly reflect the affect on the HAT barrier height.
...
deactivate \ch{C-H} bonds in complex chemical environments. As such, it seems
