...
\jnote{Include chemdraw structures of susbtrates studied herein. Also, finish framing the important questions here.}
...
\begin{table}[!htbp]
  \caption[Bond dissociation enthalpies of DMA, DMSO, MeCN, and DIA with and without metal cations.]{Bond dissociation enthalpies of DMA, DMSO, MeCN, and DIA with \ch{Na^+}, \ch{NaCl}, and without metal cations (Bare) calulated at the M05-2X-SMD/6-311+G(2d,2p)//M05-2X/6-31+G$^{**}$ level of theory. ROCBS-QB3 BDEs without metals are included for reference. All values are in \kcalmol.}
  \label{tab:bde-metal}
