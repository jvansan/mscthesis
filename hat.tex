...
to draw an important conclusion: The use of \ch{Cl^-} in the calculations
...
context of HAT reaction barrier heights, increasing the effective \ch{C-H} bond
...
to note that experiments showed that \ch{NaClO4} did not significantly effect
...
become more difficult to abstract, as evident by the higher \ch{C-H} BDEs in
...
$\Delta H^\ddagger$.  Furthermore, TSs for HAT between \ch{C-H} bond and
...
$e^-$, but the charge transfer increases with the inclusion of \ch{NaCl} to
0.26 $e^-$. This increased charge separation results in a lower enthalpic
barrier than expected solely on the basis of the increase in \ch{C-H} BDE.
...
In the abstraction of the cis position \ch{C-H} bond of DMA by \cumo, there is
...
\bno\ decrease upon complexation of \ch{NaCl} to both the acetyl and
