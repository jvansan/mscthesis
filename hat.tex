...
distance to find \ch{Na^+} from the amidic oxygen-centre is at about 2--2.5
\AA\ separation. Heyda et al. also showed that \ch{Na^+} binds more strongly
with the amide than \ch{K^+}, and that the nature of the halide counteranion
...
+0.72 in DMA to +0.74 in the DMA-\ch{Na^+} complex. The positively-charged
...
\ch{Na^+} with the oxygen-centre of DMSO.
...
$\alpha$-\ch{C-H} BDEs of DIA are greater than those of DMA, and are closer to
the $\beta$-\ch{C-H} BDEs than perhaps expected. The effects of sodium binding
to the amidic oxygen are almost nil for the $\beta$-trans C-H bond of DIA,
however there is a significant decrease in the $\beta$-cis \ch{C-H} BDE.
...
interactions can increase the effect BDEs of abstractable \ch{C-H} bonds by
