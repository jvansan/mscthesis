...
\begin{figure}[!htbp]
  ...
  \caption[Reaction profiles for HAT between HMPA and \bno\, and TBPO and \bno.]{Reaction profiles for HAT between \textbf{a} HMPA and \bno\, \textbf{b} and TBPO and \bno. Relative free energies in \kcalmol\ are shown for the conventional (black) and reverse (red) HAT reactions.}
