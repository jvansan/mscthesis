...
\begin{table}[!htbp]
  \caption{Ionic concentrations inside a mamallian cell and in the blood. Concentrations are in units of mM. Values are rounded to one significant figure. Data are from Ref. \protect\citenum{Ingwall2006} and \protext\citenum{daSilva2001}.}
  \label{tab:metalconc}
\begin{tabular}{l c c}
