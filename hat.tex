...
\jnote{For the $\alpha$-trans position there is no interaction between \ch{Na^+} and \cumo, however DIA is slightly reoriented (as compared to the structure I have excluding NaCl) so that there is more dispersion interaction. I believe I have the wrong TS structure and I am re-optimizing.}
...
% Cis beta = long-range aromatic-na interaction -> lower dH

% Trans beta = No rad-na interaction :. increase in dH result of decreased charge separation
