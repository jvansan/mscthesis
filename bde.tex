...
benzylic C-H and \ch{C-OO^.} bond strengths with experimentally-measured HAT
...
\ch{C-H} by peroxyl radicals, which were obtained through an experimental method
...
bond donating (H-Bond Donors) species, and other \ch{C-H} bonds with heteroatom
neighbours (Het. Neighbours). Doing so appears to reveal one reasonably
well-correlated trend for \ch{C-H} bonds with heteroatom neighbours ($R^2 =
...
heteroatomic neighbours trend. Excluding points for the tertiary amines results
in an $R^2 = 0.92$.
...
there are to few data points to make this assertion. Extremely poor correlation
