...
\copyrightyear{2017}
\submitdate{December 2017} % date of approved thesis (Month Year)
...
\noindent\titleline{Dr. Gino DiLabio, Irving K. Barber School of Arts and Sciences} \\
\noindent Supervisor, Professor (please print name and faculty/school above the line)

\vspace{\linespace}

\noindent\titleline{Dr. W. Stephen McNeil, Irving K. Barber School of Arts and Sciences} \\
\noindent Supervisory Committee Member, Professor (please print name and faculty/school above the line)

\vspace{\linespace}

\noindent\titleline{Dr. Frederic Menard, Irving K. Barber School of Arts and Sciences} \\
\noindent Supervisory Committee Member, Professor (please print name and faculty/school above the line)

\vspace{\linespace}

\noindent\titleline{Dr. Michael Deyholos, Irving K. Barber School of Arts and Sciences} \\
\noindent University Examiner, Professor (please print name and faculty/school above the line)

\vspace{\linespace}

\noindent\titleline{\hspace{30em}} \\
\noindent External Examiner, Professor (please print name and faculty/school above the line)

\vspace{\linespace}

\noindent\titleline{December 22, 2017} \\
\noindent(Date Submitted to Grad Studies)

\vspace{\linespace}

\noindent Additional Committee Members include:

\vspace{\linespace}

\noindent\titleline{\hspace{30em}} \\
\noindent (please print name and faculty/school above the line)
